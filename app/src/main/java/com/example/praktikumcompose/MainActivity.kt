package com.example.praktikumcompose
...
import com.example.praktikumcompose.ui.theme.PraktikumComposeTheme
import org.w3c.dom.Text
import com.example.praktikumcompose.TampilLayar as TampilLayar

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            PraktikumComposeTheme(){
                Surface(
